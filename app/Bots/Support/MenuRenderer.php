    ...
    public function for(?User $user): string
    {
        ...
        if ($isOwner) {
            ...
            if ($ownsAtLeastOnePark) {
                ...
                $lines[] = "_لتحديد سعر الحجز أرسل: *السعر*_";
            } else {
                $lines[] = "_لم تنشئ أي موقف بعد. ابدأ بـ:_";
                $lines[] = "3️⃣  إنشاء موقفك الأول";
            }
            $lines[] = "_لدخول لوحة التحكم على الويب أرسل: *تسجيل الدخول*_";
            $lines[] = '';
        }
        ...
        $lines[] = "6️⃣  *مساعدة*  — كل الأوامر";
        $lines[] = "7️⃣  *الحالة*  — حسابي وحجزي";
        $lines[] = "8️⃣  *تسجيل*  — تغيير الدور";
        $lines[] = "0️⃣  *إلغاء*  — إلغاء العملية الحالية";
